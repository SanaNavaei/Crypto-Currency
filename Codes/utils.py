...
def create_OP_CHECKSIG_signature2(txin, txout_1, txout_2, txin_scriptPubKey, seckey):
...
def create_signed_transaction2(txin, txout_1, txout_2, txin_scriptPubKey, txin_scriptSig):
    tx = CMutableTransaction([txin], [txout_1, txout_2])
